...
impl Code {
    ...
    pub fn from_error_kind(kind: std::io::ErrorKind) -> Option<Code> {
        ...
        Some(match kind {
            ...
            AddrNotAvailable => Code::EADDRNOTAVAIL,
            AlreadyExists => Code::EEXIST,
            ArgumentListTooLong => Code::E2BIG,
            BrokenPipe => Code::EPIPE,
            ConnectionAborted => Code::ECONNABORTED,
            ConnectionRefused => Code::ECONNREFUSED,
            ConnectionReset => Code::ENETRESET,
            CrossesDevices => Code::EXDEV,
            Deadlock => Code::EDEADLK,
            DirectoryNotEmpty => Code::ENOTEMPTY,
            ExecutableFileBusy => Code::EBUSY, // ETXTBSY
            FileTooLarge => Code::EFBIG,
            FilesystemLoop => Code::ELOOP,
            FilesystemQuotaExceeded => Code::EDQUOT,
            HostUnreachable => Code::EHOSTUNREACH,
            InProgress => Code::EINPROGRESS,
            Interrupted => Code::EINTR,
            InvalidData => Code::EINVAL,
            InvalidFilename => Code::EMSGSIZE,
            InvalidInput => Code::EINVAL,
            IsADirectory => Code::EISDIR,
            NetworkDown => Code::ENETDOWN,
            NetworkUnreachable => Code::ENETUNREACH,
            NotADirectory => Code::ENOTDIR,
            NotConnected => Code::ENOTCONN,
            NotFound => Code::ENOENT,
            NotSeekable => Code::ESPIPE,
            OutOfMemory => Code::ENOMEM,
            PermissionDenied => Code::EACCES,
            ReadOnlyFilesystem => Code::EROFS,
            ResourceBusy => Code::EBUSY,
            StaleNetworkFileHandle => Code::ENETUNREACH,
            StorageFull => Code::EDQUOT,
            TimedOut => Code::ETIMEDOUT,
            TooManyLinks => Code::EMLINK,
            UnexpectedEof => Code::ED_INVALID_SIZE,
            Unsupported => Code::EOPNOTSUPP,
            WouldBlock => Code::ED_WOULD_BLOCK,
            WriteZero => Code::ED_INVALID_SIZE,
            _ => return None,
        })
    }
}
